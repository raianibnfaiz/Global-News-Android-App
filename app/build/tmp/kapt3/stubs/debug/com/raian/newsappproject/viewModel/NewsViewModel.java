...
public final class NewsViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    public final void getBusinessNews() {
    }
    
    public final void getSportsNews() {
    }
    
    public final void getScienceNews() {
    }
    
    public final void getTechnologyNews() {
    }
    
    public final void setSportsArticle() {
    }
    
    public final void setBusinessArticle() {
    }
    
    public final void setScienceArticle() {
    }
    ...
    public final void addAllArticle(@org.jetbrains.annotations.NotNull()
    java.util.List<com.raian.newsappproject.models.TempArticle> article) {
    }
