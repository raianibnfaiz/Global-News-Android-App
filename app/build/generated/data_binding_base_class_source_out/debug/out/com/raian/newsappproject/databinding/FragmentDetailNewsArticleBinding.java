...
public final class FragmentDetailNewsArticleBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentDetailNewsArticleBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentDetailNewsArticleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_detail_news_article, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentDetailNewsArticleBinding bind(@NonNull View rootView) {
